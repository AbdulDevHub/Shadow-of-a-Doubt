...
{
    public enum ShieldElement { Fire, Water, Wind }
    ...
    public Color fireColor = new Color(1f, 0f, 0f, 0.4f);   // red
    public Color waterColor = new Color(0f, 0.3f, 1f, 0.4f); // blue
    public Color windColor = new Color(0f, 1f, 0f, 0.4f);    // green
    ...
    public void ActivateShield()
    {
        ...
        if (shieldRenderer != null)
        {
            ...
            switch (currentElement)
            {
                ...
                case ShieldElement.Water: matInstance.color = waterColor; break;
                case ShieldElement.Wind: matInstance.color = windColor; break;
            }
        }
    ...
    public bool CanTakeDamage(int spellIndex)
    {
        ...
        switch (currentElement)
        {
            case ShieldElement.Fire: return spellIndex == 0;
            case ShieldElement.Water: return spellIndex == 1;
            case ShieldElement.Wind: return spellIndex == 2;
        }
        return true;
    }
}
